...
export function instalarWin() {
  ...
  exeCmd(`reg add HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Run /f /t REG_SZ /v ${pkg.productName} /d "%LocalAppData%\\${pkg.productName}\\update.exe --processStart ${pkg.productName}.exe"`)
}
